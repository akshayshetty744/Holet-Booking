function calculate(){
  ...
  document.getElementById("mobile").innerHTML = document.getElementById("txtMobile").value;
  document.getElementById("date").innerHTML = document.getElementById("txtDate").value;
  document.getElementById("days").innerHTML = document.getElementById("txtDays").value;
  document.getElementById("persons").innerHTML = document.getElementById("txtPersons").value;
